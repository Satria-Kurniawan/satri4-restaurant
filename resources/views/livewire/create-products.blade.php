    ...
    <div class="flex items-end justify-center min-h-screen pt-2 px-2 pb-20 text-center sm:block sm:p-0"> --}}
      ...
      -->
        {{-- <div class="inline-block align-middle bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
            ...
            <div class="bg-white px-4 pt-3 pb-4 sm:p-6 sm:pb-3">
            <div class="sm:flex sm:items-start">
                <div class="flex flex-wrap -mx-3 mb-3"> --}}
                    ...
                    <div class="w-full mb-0 ">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-1" for="price">
                        Price
                        </label>
                    ...
                    <div class="w-full mb-0 ">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-1" for="picture">
                        Picture
                        </label>
                    ...
                    <div class="w-full mb-0 ">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-1" for="qty">
                        Quantity
                        </label>
                        <input wire:model="qty" class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 border-black leading-tight focus:outline-none focus:bg-white" id="qty" name="qty" type="number" placeholder="Masukan quantity">
                        @error('Quantity')
                            <h1 class="text-red-900">{{ $message }}</h1>
                        @enderror
                    </div>
...
<div class="row mb-4">
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                <h2 class="font-weight-bold mb-3">ADD PRODUCT</h2>
                <div class="w-full mb-0">
                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-1" for="name">
                        Kategori
                    </label>
                ...
                <div class="w-full mb-0 ">
                    ...
                    <input wire:model="price" class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 border-black leading-tight focus:outline-none focus:bg-white" id="price" name="price" type="number" placeholder="Masukan harga">
                    @error('price')
                        <h1 class="text-red-900">{{ $message }}</h1>
                    @enderror
                </div>
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                <h2 class="font-weight-bold mb-3">NEXT...</h2>
                <div class="w-full mb-0 ">
                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-1" for="picture">
                    Picture
                    </label>
